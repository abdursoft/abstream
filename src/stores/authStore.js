...
import { authCheck, newPassword, otpVerify, profileData, profileImage, sendOTP, signin, signOTP, signup } from "@/server/api/apiRoutes";
    ...
    actions:{
      ...
      async userProfile(data){
        ...
        try {
          ...
          const res = await axios.post(profileImage,form,{'headers':{
      ...
      async signupOTPVerify(data){
        this.site.setLoader(true);
        try {
          const res = await axiosClient.post(signOTP,data,{otpToken: localStorage.getItem('otpToken')});
          this.site.setLoader(false);
          return res;
        } catch (error) {
          this.site.setLoader(false);
      ...
      async verifyPasswordOTP(data){
        this.site.setLoader(true);
        try {
          const res = await axiosClient.post(otpVerify,data,{headers:{
      ...
      async setNewPassword(data){
        this.site.setLoader(true);
        try {
          const res = await axiosClient.post(newPassword,data,{headers:{
